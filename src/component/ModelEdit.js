...
function ModalEdit({ onOpen ,location}) {
...
event.preventDefault();
  ...
  if (newCity.trim() === "") {
    ...
    axios.get(`https://react-malaysia-state-default-rtdb.firebaseio.com/location/${location}/state.json`)
      .then((response) => {
        ...
        if (response.data) {
          ...
          axios.put(`https://react-malaysia-state-default-rtdb.firebaseio.com/location/${location}/state.json`, existingCities)
            .then((response) => {
